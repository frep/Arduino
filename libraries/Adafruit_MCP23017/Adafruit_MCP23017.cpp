...
/**
 * Read the GPIO-Register A at once.
 */
uint8_t Adafruit_MCP23017::readGpioA(void)
{
    return readRegister(MCP23017_GPIOA);
}

/**
 * Read the GPIO-Register B at once.
 */
uint8_t Adafruit_MCP23017::readGpioB(void)
{
    return readRegister(MCP23017_GPIOB);
}

/**
 * Writes all of the pins of GPIO-Register A at once.
 */
void Adafruit_MCP23017::writeGpioA(uint8_t value)
{
    writeRegister(MCP23017_GPIOA, value);
}

/**
 * Writes all of the pins of GPIO-Register B at once.
 */
void Adafruit_MCP23017::writeGpioB(uint8_t value)
{
    writeRegister(MCP23017_GPIOB, value);
}

/**
 * Writes the pin direction of the whole GPIOA-register
 */
void Adafruit_MCP23017::writeRegDirA(uint8_t value)
{
    writeRegister(MCP23017_IODIRA, value);
}

/**
 * Writes the pin direction of the whole GPIOB-register
 */
void Adafruit_MCP23017::writeRegDirB(uint8_t value)
{
    writeRegister(MCP23017_IODIRB, value);
}
