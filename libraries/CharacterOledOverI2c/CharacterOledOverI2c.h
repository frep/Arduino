#ifndef CharacterOledOverI2c_h
#define CharacterOledOverI2c_h
...
class CharacterOledOverI2c : public Print {
public:
  CharacterOledOverI2c(uint8_t ver, uint8_t rs, uint8_t rw, uint8_t enable,
